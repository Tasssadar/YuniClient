...
public class DeviceInfo
{
    DeviceInfo(String id)
    {
        ...
        else if(id.contentEquals("m88")) { name = "ATmega88";    mem_size = 7936;  page_size = 64;  }
        ...
        else if(id.contentEquals("m328")){ name = "ATmega328P";  mem_size = 32256; page_size = 128; }
        else if(id.contentEquals("m8u2")){ name = "ATmega8u2";   mem_size = 7680;  page_size = 128; }
        ...
        else if(id.contentEquals("p128")){ name = "ATmega1284P"; mem_size = 65536; page_size = 256; }
    }
